...
public class BottomSheetDialogJoinGroup extends BottomSheetDialogFragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    v = inflater.inflate(R.layout.dialog_join_group, container, false);
    ...
    btnRequestJoin = v.findViewById(R.id.btnRequestJoin);
          ...
          public void onSuccess(String response) {
            try {
              ...
              if (status.equalsIgnoreCase("success")) {
                ...
                User sendToMode = MyPreferenceManager.getInstance(mContext).getUser();
