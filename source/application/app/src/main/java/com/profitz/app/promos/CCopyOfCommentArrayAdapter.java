...
import com.profitz.app.promos.adapters.ECCardContentListItemAdapterPro;
...
public class CCopyOfCommentArrayAdapter extends ECCardContentListItemAdapterPro<Comment> {

    public CCopyOfCommentArrayAdapter(@NonNull Context context, @NonNull List<Comment> objects) {
