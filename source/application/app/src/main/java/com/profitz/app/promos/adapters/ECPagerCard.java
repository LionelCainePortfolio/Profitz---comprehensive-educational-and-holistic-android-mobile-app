...
public class ECPagerCard extends FrameLayout {
    ...
    private ECPagerCardContentListPro ecPagerCardContentList;
    ...
    protected void onFinishInflate() {
        ...
        try {
            ecPagerCardContentList = (ECPagerCardContentListPro) getChildAt(0);
//            ecPagerCardListContent.disableScroll();
    ...
    public boolean expand() {
       ...
       int expandedCardHeight = pagerParent.getHeight()+3200;
...
//                ecPagerCardContentList.enableScroll();
        ...
        pager.animateHeight(expandedCardHeight, cardAnimDuration, cardAnimDelay, onAnimationEnd); //wysokosc
...
//        ecPagerCardListContent.disableScroll();
    ...
    public ECPagerCardContentListPro getEcPagerCardContentListPro() {
