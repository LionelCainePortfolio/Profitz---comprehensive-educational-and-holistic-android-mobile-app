...
public class MyInformationsTab2Fragment extends Fragment implements IMethodCaller {
    String username;
    ...
    public MyInformationsTab2Fragment() {
    ...
    public void openDialogConfirm(){
        ...
        dialog_confirm_delete_all .getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (count_notifications.equals("0")) {
                                ...
                                new MyInformationsTab2Fragment.AsyncNotifications().execute();
    ...
    class AsyncNotifications extends AsyncTask<String, String, String> {
...
*/
    ...
    public void deleteItemDatabase(int itemId) {
      //  Log.d("deletedItemFromDB", String.valueOf(itemId));
