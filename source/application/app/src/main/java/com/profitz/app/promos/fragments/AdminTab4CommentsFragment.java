...
public class AdminTab4CommentsFragment extends Fragment implements IMethodCaller {
    String username;
    ...
    public AdminTab4CommentsFragment() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (count_notifications.equals("0")) {
                                ...
                                new AdminTab4CommentsFragment.AsyncLogin().execute();
