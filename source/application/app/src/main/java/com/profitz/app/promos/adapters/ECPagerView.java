...
public class ECPagerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context) {
        ...
        layoutParams.setMargins(0, 0, 0, 0); //substitute parameters for left, top, right, bottom
    ...
    public void onPageScrollStateChanged(int state) {
     ...
     void toggleTopMargin(int duration, int delay) {
    ...
    public void setBackgroundSwitcherView(ECBackgroundSwitcherView imageSwitcher) {
        ...
        ECPagerViewAdapterPro adapter = (ECPagerViewAdapterPro) this.pager.getAdapter();
    ...
    /**
     * Set {@link ECPagerViewAdapterPro} to pager
     *
     * @param adapter implementation of {@link ECPagerViewAdapterPro}
     */
    public void setPagerViewAdapter(ECPagerViewAdapterPro adapter) {
