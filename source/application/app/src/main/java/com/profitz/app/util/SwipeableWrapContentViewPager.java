...
public class SwipeableWrapContentViewPager extends ViewPager {
    ...
    public SwipeableWrapContentViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.enabled = true;
    }

    public SwipeableWrapContentViewPager(@NonNull Context context) {
        super(context);
    }
