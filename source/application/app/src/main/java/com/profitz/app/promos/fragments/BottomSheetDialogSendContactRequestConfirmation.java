...
import com.profitz.app.promos.activities.AddUserInContactListActivity;
...
public class BottomSheetDialogSendContactRequestConfirmation extends BottomSheetDialogFragment {
    ...
    private int position,userId;
    private NestedScrollView parentLayout;
    private TextView confirmation_send_contact_request_text;
...
// window.findViewById(R.id.design_bottom_sheet).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.dialog_send_contact_request_confirmation, container, false);
        ...
        confirmation_send_contact_request_text = v.findViewById(R.id.confirmation_send_contact_request_text);

        String confirmation_send_contact_request_text_string = "Wysłać prośbę o kontakt do użytkownika " + username + "?";
        confirmation_send_contact_request_text.setText(confirmation_send_contact_request_text_string);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AddUserInContactListActivity)getActivity()).respondToSendContactRequestConfirmation(position, userId);
                dismiss();
            }
        });
