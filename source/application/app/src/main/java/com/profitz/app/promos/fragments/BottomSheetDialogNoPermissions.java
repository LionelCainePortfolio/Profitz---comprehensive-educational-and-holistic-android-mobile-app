...
public class BottomSheetDialogNoPermissions extends BottomSheetDialogFragment {
  ...
  private TextView text_no_permissions;
  @NonNull
  @Override
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
    ...
    v = inflater.inflate(R.layout.dialog_no_permissions, container, false);
    ...
    text_no_permissions = v.findViewById(R.id.text_no_permissions);
    Bundle mArgs = getArguments();
    text = mArgs.getString("text");

    text_no_permissions.setText(text);
