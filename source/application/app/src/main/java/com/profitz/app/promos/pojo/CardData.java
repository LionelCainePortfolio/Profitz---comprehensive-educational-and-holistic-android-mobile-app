package com.profitz.app.promos.pojo;
...
public class CardData implements ECCardData<CommentCard> {
    ...
    private List<CommentCard> listItems;
    ...
    @Override
    public List<CommentCard> getListItems() {
        return listItems;
    }

    public void setListItems(List<CommentCard> listItems) {
