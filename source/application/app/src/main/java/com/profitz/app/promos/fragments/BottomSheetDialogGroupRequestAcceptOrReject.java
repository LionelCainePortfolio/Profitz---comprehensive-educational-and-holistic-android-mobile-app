...
public class BottomSheetDialogGroupRequestAcceptOrReject extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                index = mArgs.getInt("index");
                    ...
                    ((GroupMetaDetailActivity)getActivity()).respondToGroupRequestActivity(index, "accept");
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mArgs != null) {
                    index = mArgs.getInt("index");
                    ((GroupMetaDetailActivity)getActivity()).respondToGroupRequestActivity(index, "decline");
                }
                dismiss();
            }
        });
