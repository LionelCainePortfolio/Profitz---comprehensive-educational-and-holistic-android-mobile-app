...
public class AdminTab5NotificationsFragment extends Fragment implements IMethodCaller {
    String username;
    ...
    public AdminTab5NotificationsFragment() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (count_notifications.equals("0")) {
                                ...
                                new AdminTab5NotificationsFragment.AsyncLogin().execute();
