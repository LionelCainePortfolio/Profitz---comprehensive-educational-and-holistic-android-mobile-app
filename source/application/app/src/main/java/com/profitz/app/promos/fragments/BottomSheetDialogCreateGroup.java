...
public class BottomSheetDialogCreateGroup extends BottomSheetDialogFragment {
...
// window.findViewById(R.id.design_bottom_sheet).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.dialog_create_group, container, false);
...
if (isOpen){
    ...
    parentLayout.setPadding(0,0,0,dpAsPixels);
}
else{
    parentLayout.setPadding(0,0,0,dpAsPixels2);
}
        ...
        createGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Utility.isEmpty(Utility.getStringValue(groupName))) {
                //    Toast.makeText(mContext, "Wprowadź nazwę grupy.", Toast.LENGTH_LONG).show();
                    Toasty.error(mContext, "Wprowadź nazwę grupy.").show();
    ...
    private void createNewGroup() {
        ...
        httpManager.createNewGroup(Utility.getStringValue(groupName), new HttpResponse() {
            @Override
                ...
                try {
                 ...
                 //   Toast.makeText(mContext, message, Toast.LENGTH_LONG).show();
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        groupsModel.setGroup_name(Utility.getStringValue(groupName));
                        groupsModel.setAm_I_member(false);
                        groupsModel.setPicture("https://yoururl.com/api/scp/groups/default_group.png");

                        SocketManager.groupCreated(groupsModel);
                        dismiss();
                    }
