...
public class BottomSheetDialogReportIssue extends BottomSheetDialogFragment {
...
// window.findViewById(R.id.design_bottom_sheet).setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (isAirdrop.equals("1")){
            v = inflater.inflate(R.layout.dialog_report_airdrop, container, false);

        }
        else{
            v = inflater.inflate(R.layout.dialog_report_promo, container, false);
        }
        ...
        RelativeLayout sendReportInactive = v.findViewById(R.id.sendReportInactive);
        RelativeLayout sendReportUrl = v.findViewById(R.id.sendReportUrl);
        RelativeLayout sendReportOther = v.findViewById(R.id.sendReportOther);

        sendReportInactive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isAirdrop.equals("1")){
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=1&user_id="+userId+"&airdrop_id="+airdropId+"&username="+username+"&reason=inactive";

                }
                else{
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=0&user_id="+userId+"&promo_id="+promoId+"&username="+username+"&reason=inactive";
                }
        ...
        sendReportUrl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isAirdrop.equals("1")){
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=1&user_id="+userId+"&airdrop_id="+airdropId+"&username="+username+"&reason=url";

                }
                else{
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=01&user_id="+userId+"&promo_id="+promoId+"&username="+username+"&reason=url";
                }
                jsonObjectRequestSendReport = new JsonObjectRequest
                        (com.android.volley.Request.Method.GET, url_send_report, null, new Response.Listener<JSONObject>() {
        ...
        sendReportOther.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isAirdrop.equals("1")){
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=1&user_id="+userId+"&airdrop_id="+airdropId+"&username="+username+"&reason=other";

                }
                else{
                    url_send_report = "https://yoururl.com/api/send_report_issue.php?is_airdrop=0&user_id="+userId+"&promo_id="+promoId+"&username="+username+"&reason=other";
                }
