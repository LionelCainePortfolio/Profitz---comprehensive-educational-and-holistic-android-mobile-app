...
public class AdminTab2DonesFragment extends Fragment implements IMethodCaller {
    String username;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (count_notifications.equals("0")) {
                                ...
                                new AdminTab2DonesFragment.AsyncLogin().execute();
